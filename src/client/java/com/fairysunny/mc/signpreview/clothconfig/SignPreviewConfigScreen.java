...
public class SignPreviewConfigScreen {
    public static Screen create(Screen parent) {
        var builder = ConfigBuilder.create()
                ...
                .setTitle(Component.translatable("title.signpreview.config"))
                .setSavingRunnable(() -> SignPreview.CONFIG.save(SignPreviewConfig.getDefaultPath()));

        var entryBuilder = builder.entryBuilder();

        builder.getOrCreateCategory(Component.translatable("category.signpreview.general"))
                .addEntry(entryBuilder
                        .startDoubleField(Component.translatable("option.signpreview.maxPreviewDistance"),
